...
import skimage.exposure.histogram as histo
...
cont_im = automatic_brightness_and_contrast(image_gray)
thresh = threshold_otsu(image_gray)

blurred_image = skimage.filters.gaussian(image_gray, sigma=1)
binary_mask = blurred_image > thresh*0.98
labeled_image, count = skimage.measure.label(binary_mask,
...
ax[0].imshow(image)
ax[1].imshow(cont_im,cmap='Greys_r')
plt.axis("off")
plt.show()
